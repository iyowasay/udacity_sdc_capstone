...
class DBWNode(object):
    def __init__(self):
        ...
        fuel_capacity = rospy.get_param('~fuel_capacity', 13.5) # might need this?
    ...
    def loop(self):
        rate = rospy.Rate(50) # important, must be 50Hz for the sake of DBW
    ...
    def dbw_enabled_cb(self, msg): # cb = call back
